...
**D.3 is the first agent built fresh against the post-v1.2 canon.**
The fact that this file is 25 lines instead of 55 (D.1's pre-hoist
version) is the visible validation that the hoist was correctly sized.
"""
