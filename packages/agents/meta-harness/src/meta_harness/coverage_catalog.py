...
CATALOG: tuple[Family, ...] = (
    ...
    Family("network_topology_lateral", "Lateral Movement", "network_topology_lateral", Status.PLANNED),
    # --- Impact domains ---
    ...
    Family("supply_chain_sbom", "Initial Access", "supply_chain_sbom", Status.PLANNED),
