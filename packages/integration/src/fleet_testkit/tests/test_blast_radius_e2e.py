...
async def test_blast_radius_counts_reachable_data() -> None:
    async with in_memory_semantic_store() as store:
        ...
        assert max(c.blast_radius for c in cards) == 3, "admin reaches 3 data stores → blast radius 3"
