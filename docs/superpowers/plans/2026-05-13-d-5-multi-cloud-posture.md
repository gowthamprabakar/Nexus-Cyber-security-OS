...
| 14   | ✅ done | `3f790d0` | CLI (`multi-cloud-posture eval` / `multi-cloud-posture run`) — two subcommands; four optional feed flags + repeatable `--customer-domain`. One-line digest; warning on no-feed. 10 tests.                                                                                                                                                                                                   |
| 15   | ✅ done | `3f790d0` | README rewritten for v0.1 ship; operator runbook (`runbooks/multicloud_scan.md`, 8 sections). ADR-007 v1.1 + v1.2 conformance verified; v1.3 + v1.4 opt-outs confirmed.                                                                                                                                                                                                                     |
| 16   | ✅ done | `3f790d0` | Verification record (`docs/_meta/d5-verification-2026-05-13.md`). Repo-wide 1785 passed / 11 skipped. Coverage 94% on `multi_cloud_posture.*`. **D.5 done; Phase 1b detection track 75% done.**                                                                                                                                                                                             |
