...
| 16   | ✅ done    | `ea2a7f5` | README + operator runbook (`runbooks/investigation_workflow.md`, 7 sections). ADR-007 v1.4 evaluated + **deferred** (one consumer; rehoist when third duplicate appears). Verification record: `docs/_meta/d7-verification-2026-05-13.md`. Repo-wide 1340 passed / 11 skipped. Coverage 94% on `investigation.*`. **D.7 done; Phase 1b open.**        |
