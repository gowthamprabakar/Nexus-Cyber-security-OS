...
| 16   | ✅ done | `944dde2` | README rewritten (full operator-facing content); operator runbook (`runbooks/k8s_scan.md`, 9 sections); verification record (`docs/_meta/d6-verification-2026-05-13.md`); 245 tests; 97% coverage; **Phase-1b detection track CLOSED 2026-05-13** (D.7 + D.4 + D.5 + D.6 all shipped at M2).                                               |
