...
| ---- | ---------- | ------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1    | ⬜ pending | —      | Bootstrap — `packages/agents/remediation/pyproject.toml` (BSL 1.1; deps on charter / shared / eval-framework / nexus-cloud-posture / nexus-k8s-posture / kubernetes); smoke gate (~9 tests covering ADR-007 v1.1 + v1.2 + F.1 audit log + F.5 episodic + schema availability + 2 anti-pattern guards + 2 entry-points + kubernetes SDK importable). Workspace member added.                                 |
