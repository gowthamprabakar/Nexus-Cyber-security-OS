...
| **Non-admin escalation targets**               | principal --CAN_ESCALATE_TO--> _any higher-priv_ identity (today: admin only)                                                                                                    | target set is admin-only                                                                               | REAL                      | edge breadth — catches privesc to a non-admin role that still reaches data                 |
